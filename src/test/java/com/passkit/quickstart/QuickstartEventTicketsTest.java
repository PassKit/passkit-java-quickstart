...
public class QuickstartEventTicketsTest {
    ...
    public void quickstartEventTicketsTest() {
        ...
        assertNotEquals("expect appleLogo image id not to be empty", "",
                QuickstartEventTickets.eventImageIds.getAppleLogo());
        assertNotEquals("expect strip image id not to be empty", "",
                QuickstartEventTickets.eventImageIds.getEventStrip());
        ...
        assertNotEquals("expect thumbnail image id not to be empty", "",
                QuickstartEventTickets.eventImageIds.getThumbnail());
        assertNotEquals("expect background image id not to be empty", "",
                QuickstartEventTickets.eventImageIds.getBackground());
        ...
        assertEquals("length of template id should be 22 characters", 22,
                QuickstartEventTickets.baseTemplateId.getId().length());
        assertEquals("length of template id should be 22 characters", 22,
                QuickstartEventTickets.vipTemplateId.getId().length());
        ...
        assertEquals("length of template id should be 22 characters", 22,
                QuickstartEventTickets.baseTicketTypeId.getId().length());
        assertNotNull("expect ticket type not to be null", QuickstartEventTickets.vipTicketTypeId);
        assertEquals("length of template id should be 22 characters", 22,
                QuickstartEventTickets.vipTicketTypeId.getId().length());
        ...
        assertEquals("length of program id should be 22 characters", 22,
                QuickstartEventTickets.baseTicket.getId().length());
        ...
        assertEquals("length of program id should be 22 characters", 22,
                QuickstartEventTickets.vipTicket.getId().length());
